...
public:
    TimelordTest()
        ...
        , timelord_(ioc_, rpc_, ExpandEnvPath(SZ_VDF_CLIENT_PATH), SZ_VDF_CLIENT_ADDR, VDF_CLIENT_PORT, 200000, persist_operator_, storage_, [](uint256 const& challenge, Bytes const& y, Bytes const& proof, int witness_type, int iters, int duration) {})
    {
    }
