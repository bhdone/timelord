...
int main(int argc, char* argv[])
{
    ...
    opts.add_options()
        ...
        ("rpc", "The endpoint of btchd core", cxxopts::value<std::string>()->default_value("http://127.0.0.1:18732"))
        ("cookie", "Full path to the `.cookie` file generated by btchd core", cxxopts::value<std::string>()->default_value("$HOME/.btchd/testnet3/.cookie"))
        ;
    ...
    Timelord timelord(url, cookie_path);
